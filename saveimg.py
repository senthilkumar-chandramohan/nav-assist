...
csv_File_Path = '/mnt/c/projects/nav-assist/server/data/sample_images.csv'

count = 1
last_digit_Name =  None

image_Folder_Path = '/mnt/c/projects/nav-assist/server/data/'
#your path to target folder to save images. Note: Path should have 26 empty folder with name as alphabets
